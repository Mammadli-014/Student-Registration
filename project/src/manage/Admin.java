...
public class Admin extends Person {
    ...
    public static void personAdd(Object o) {
        try {
    ...
    // Method to check if the provided administrator and password match
    public static boolean isEntry(Admin administrator, String aPassword) {
        return Config.getInstance().getAllAdmins().contains(administrator) && administrator.getPassword().equals(aPassword);
    }
